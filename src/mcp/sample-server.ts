...
import { z } from "zod";
import { setupAuthServer } from "./sample/demoInMemoryOAuthProvider";
import { InMemoryEventStore } from "./sample/inMemoryEventStore";
...
const mcpPostHandler = async (req: Request, res: Response) => {
	...
	console.log(
		sessionId ? `Received MCP request for session: ${sessionId}` : "Received MCP request:",
		req.body,
	);
